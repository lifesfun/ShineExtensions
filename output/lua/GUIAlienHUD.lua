...
local CHUDTextureName = PrecacheAsset("ui/oma_alien_hud_health.dds")
local kTextureNameOrig = kTextureName
...
function GUIAlienHUD:Initialize()
	...
	if CHUDSettings["alienbars"] then
		kTextureName = CHUDTextureName
	else
		kTextureName = kTextureNameOrig
	end
...
function GUIAlienHUD:CreateHealthBall()
	...
	if CHUDSettings["mingui"] then
		kHealthBackgroundTextureX2 = 0
		kHealthBackgroundTextureY2 = 0
	else
		kHealthBackgroundTextureX2 = 128
		kHealthBackgroundTextureY2 = 128
	end
