...
local function OnCommandChange( client , className, teamNumber, extraValues)
...
Event.Hook("Console_change", OnCommandChange)
Event.Hook("Console_mac", OnCommandChangeClass("mac", kTeam1Index))
Event.Hook("Console_drifter", OnCommandChangeClass("drifter", kTeam1Index))
